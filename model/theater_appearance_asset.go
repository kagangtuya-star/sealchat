...
type TheaterAppearanceAssetModel struct {
	...
	SharedSourceAssetID    string     `json:"sharedSourceAssetId,omitempty" gorm:"size:100;default:null;uniqueIndex:udx_theater_shared_asset_mapping,priority:1"`
	SharedTargetChannelID  string     `json:"-" gorm:"size:100;default:null;uniqueIndex:udx_theater_shared_asset_mapping,priority:2"`
	SharedTargetIdentityID string     `json:"-" gorm:"size:100;default:null;uniqueIndex:udx_theater_shared_asset_mapping,priority:3"`
	SharedTargetVariantID  string     `json:"-" gorm:"size:100;not null;default:'';uniqueIndex:udx_theater_shared_asset_mapping,priority:4"`
