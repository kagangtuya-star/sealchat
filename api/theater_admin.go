...
func bindTheaterRoutes(router fiber.Router, base string) {
	...
	router.Get(base+"/scene-overlay-presets", TheaterSceneOverlayPresetList)
	router.Post(base+"/scene-overlay-presets", TheaterSceneOverlayPresetPost)
	router.Patch(base+"/scene-overlay-presets/:presetId", TheaterSceneOverlayPresetPatch)
	router.Delete(base+"/scene-overlay-presets/:presetId", TheaterSceneOverlayPresetDelete)
	router.Get(base+"/image-assets", TheaterImageAssetList)
	router.Post(base+"/image-assets", TheaterImageAssetCreate)
	router.Patch(base+"/image-assets/:assetId", TheaterImageAssetUpdate)
	router.Delete(base+"/image-assets/:assetId", TheaterImageAssetDelete)
	...
	router.Post(base+"/packages/export/effects", TheaterEffectPackageExportCreate)
