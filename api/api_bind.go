...
func Init(config *utils.AppConfig, uiStatic fs.FS) {
	...
	v1Auth.Get("/channel-folders", ChannelFolderList)
	v1Auth.Post("/channel-folders", ChannelFolderCreate)
	v1Auth.Put("/channel-folders/:id", ChannelFolderUpdate)
	v1Auth.Delete("/channel-folders/:id", ChannelFolderDelete)
	v1Auth.Post("/channel-folders/assign", ChannelFolderAssign)
	v1Auth.Post("/channel-folders/:id/favorite", ChannelFolderToggleFavorite)
	...
	v1Auth.Post("/channel-config-sync", ChannelConfigSync)
