...
var builtinChannelIFormTools = []BuiltinChannelIFormToolRegistration{
	{
		Key: "theater-character-portrait", Directory: "theater-character-portrait", Name: "小剧场透明角色立绘",
		Description: "独立绑定频道角色的透明立绘组件，可重复安装", DefaultWidth: 480, DefaultHeight: 720,
		AllowPopout: true,
	},
	{
